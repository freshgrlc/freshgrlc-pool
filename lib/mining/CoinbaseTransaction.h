...
class CoinbaseTransaction
{
    public:
        ...
        static CoinbaseTransaction build(uint32_t height, uint32_t nonce1, uint32_t nonce2, const ConstByteStringRef &identification, const CoinbaseOutputs &outputs);
    ...
    private:
        ...
        static script::Script makeCoinbaseRedeemScript(uint32_t height, uint32_t nonce1, uint32_t nonce2, const ConstByteStringRef &identification, size_t &part1Size, size_t &part2Start);
};
